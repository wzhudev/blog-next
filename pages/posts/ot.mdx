...
This article was originally posted on [the Univer blog](https://univer.ai/blog/post/ot). It also has a [Chinese version](https://univer.ai/zh-CN/blog/post/ot).
